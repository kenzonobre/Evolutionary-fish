...
Here is a link for further details about noise and evolution analysis, and a detailed explanation of the evolutionary methods used : [documentation](https://github.com/kenzonobre/Evolutionary-fish/blob/main/docs/evolutionAnalysis.md)
