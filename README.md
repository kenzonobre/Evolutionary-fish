...
Here is a link for further details about noise analysis, evolution analysis and evolutionary methods : [documentation](https://github.com/kenzonobre/Evolutionary-fish/blob/main/docs/evolutionAnalysis.md)
